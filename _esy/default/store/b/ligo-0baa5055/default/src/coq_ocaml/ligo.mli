...
| E_lam of 'a * ('a, 'op, 'lit) binds * ('a, string) node
...
| E_unit of 'a
| E_left of 'a * ('a, string) node * ('a, 'op, 'lit) expr
| E_right of 'a * ('a, string) node * ('a, 'op, 'lit) expr
...
| E_loop_left of 'a * splitting * ('a, 'op, 'lit) binds * ('a, string) node
   * ('a, 'op, 'lit) expr
| E_fold of 'a * splitting * ('a, 'op, 'lit) expr * splitting
   * ('a, 'op, 'lit) expr * ('a, 'op, 'lit) binds
| E_fold_right of 'a * ('a, string) node * splitting * ('a, 'op, 'lit) expr
   * splitting * ('a, 'op, 'lit) expr * ('a, 'op, 'lit) binds
| E_failwith of 'a * ('a, 'op, 'lit) expr
| E_raw_michelson of 'a * ('a, string) node * ('a, string) node
   * ('a, string) node list
| E_global_constant of 'a * ('a, string) node * string * ('a, 'op, 'lit) args
and ('a, 'op, 'lit) args =
| Args_nil
| Args_cons of splitting * ('a, 'op, 'lit) expr * ('a, 'op, 'lit) args
and ('a, 'op, 'lit) binds =
| Binds of usage list * ('a, string) node list * ('a, 'op, 'lit) expr
and ('a, 'op, 'lit) cond =
| Cond of splitting * ('a, 'op, 'lit) expr * splitting
   * ('a, 'op, 'lit) binds * ('a, 'op, 'lit) binds
and ('a, 'op, 'lit) static_args =
| Type_args of string option * ('a, string) node list
| Instr_arg of ('a, 'op, 'lit) binds
| Script_arg of ('a, 'op, 'lit) script
and ('a, 'op, 'lit) script =
| Script of ('a, string) node * ('a, string) node * ('a, 'op, 'lit) binds
